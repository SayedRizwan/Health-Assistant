...
class ResultPageIW extends StatelessWidget {
 late DatabaseHandler handler;
  ResultPageIW({required this.bmiResult, required this.resultText, required this.interpretation});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:AppBar(
        title: Row(
              ...
              Container(
                  padding: const EdgeInsets.all(8.0), child: Text('IDEAL WEIGHT RESULT',
        style: TextStyle(
          fontSize: 12,
    ...
    User firstUser = User(title: "IW", value: double.parse(bmiResult));
